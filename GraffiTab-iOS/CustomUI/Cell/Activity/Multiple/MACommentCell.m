...
- (void)setItem:(GTActivityContainer *)item {
    ...
    NSString *text = [NSString stringWithFormat:NSLocalizedString(@"MA_COMMENT", nil), item.activityUser.fullName, item.activities.count];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    GTActivityComment *typedItem = (GTActivityComment *)self.item.activities[indexPath.row];
