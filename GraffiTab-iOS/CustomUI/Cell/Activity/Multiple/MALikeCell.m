...
- (void)setItem:(GTActivityContainer *)item {
    ...
    NSString *text = [NSString stringWithFormat:NSLocalizedString(@"MA_LIKE", nil), item.activityUser.fullName, item.activities.count];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    GTActivityLike *typedItem = (GTActivityLike *)self.item.activities[indexPath.row];
