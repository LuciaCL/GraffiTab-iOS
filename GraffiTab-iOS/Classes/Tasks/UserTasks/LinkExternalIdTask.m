...
@implementation LinkExternalIdTask

- (void)linkExternalId:(NSString *)externalId successBlock:(void (^)(ResponseObject *))successBlock failureBlock:(void (^)(ResponseObject *))failureBlock {
    self.sBlock = successBlock;
    self.fBlock = failureBlock;
    
    NSString *string = [RequestBuilder buildLinkExternalId];
