//
//  JTCollectionMaterialTransition.m
...
@implementation JTCollectionMaterialTransition
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    CGAffineTransform finalTransform;
    {
        ...
        CGFloat scaleFactor = size / MIN(CGRectGetWidth(animatedViewForTransition.frame), CGRectGetHeight(animatedViewForTransition.frame));
